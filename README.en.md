...
I work on **process automation, applied AI and integrations**. I talk with users to understand rules and exceptions, build the solution, and support deployment and use. In my current role, I also provide hands-on IT support for users and internal systems.

## Results in use

- **10k+ production workflow executions** in the n8n environment I administer.
...
The [Vesper Proposals case](https://mayconxzdev.github.io/en/cases/vesper-propostas/) describes an internal system whose source code is private. [Mala Direta](https://github.com/Mayconxzdev/MalaDireta) automates email campaigns with n8n; [HelpDesk](https://github.com/Mayconxzdev/HelpDesk) is used by 11 people, and its local AI assistance remains experimental.

I also developed [Hubora](https://github.com/Mayconxzdev/Hubora), a demonstration product, and the [Operational Catalog](https://github.com/Mayconxzdev/CatalogoOperacional) for procurement. The [Portal](https://github.com/Mayconxzdev/Portal) is in development; its public case describes an earlier sanitized version.

## How I work

I understand workflows and their exceptions, choose an appropriate level of automation, connect APIs or internal systems, test failure and duplicate handling, and support deployment and training. External actions and AI-generated content include human review and clear limits.
